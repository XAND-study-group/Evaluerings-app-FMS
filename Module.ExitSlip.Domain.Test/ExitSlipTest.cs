...
public class ExitSlipTests
{
    ...
    public void Given_Valid_Data_Then_Create_Success(Guid subjectId, Guid lectureId, string title, int maxQuetionCount,
    ...
    public void Given_Valid_Title_While_Status_Active_Then_Throw_ArgumentException(FakeExitSlip exitSlipToUpdate,
        string title)
    {
        // Arrange
    ...
    public void Given_Invalid_Title_While_Status_Inactive_Then_Throw_ArgumentException(FakeExitSlip exitSlipToUpdate,
        string title)
    {
        // Arrange
    ...
    public void Given_Valid_Data_Then_Update_ActiveStatus_Success(FakeExitSlip exitSlipToUpdate,
        ExitSlipActiveStatus activeStatus)
    {
        // Act  
    ...
    public void Given_Over_Hundred_Characters_Then_Throw_ArgumentException()
    {
        // Arrange
        var exitSlip = new FakeExitSlip();
        var overHundredCharTitle = new string('X', 101);
    ...
    public void Given_A_Hundred_Characters_Then_Void()
    {
        // Arrange
        var exitSlip = new FakeExitSlip();
        var hundredCharTitle = new string('A', 100);
