...
public record ChangeFeedbackStatusCommand(ChangeFeedbackStatusRequest ChangeFeedbackStatusRequest) : IRequest<Result<bool>>;

public class ChangeFeedbackStatusCommandHandler(IFeedbackRepository feedbackRepository) : IRequestHandler<ChangeFeedbackStatusCommand, Result<bool>>
{
