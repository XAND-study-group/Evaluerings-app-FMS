...
public record RemoveClassIdFromRoomCommand(RemoveClassIdFromRoomRequest RemoveClassIdFromRoomRequest) : IRequest<Result<bool>>;

public class RemoveClassIdFromRoomCommandHandler(IRoomRepository roomRepository) : IRequestHandler<RemoveClassIdFromRoomCommand, Result<bool>>
{
