...
public class IsUserInRoomCreateFeedbackCommandHandler(IRoomRepository roomRepository)
    : IRequestHandler<IsUserInRoomCreateFeedbackCommand, Result<bool>>
{
    async Task<Result<bool>> IRequestHandler<IsUserInRoomCreateFeedbackCommand, Result<bool>>.Handle(
        IsUserInRoomCreateFeedbackCommand request, CancellationToken cancellationToken)
    {
