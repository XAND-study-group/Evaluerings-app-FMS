...
namespace Module.Feedback.Infrastructure.Mapper
{
    public class MappingProfileFeedback : Profile
    {
        ...
        {
            CreateMap<Domain.Feedback, GetAllFeedbacksResponse>(MemberList.None)
            ...
            CreateMap<Domain.Feedback, GetFeedbackResponse>(MemberList.None)
            ...
            CreateMap<Room, GetAllRoomsResponse>(MemberList.None)
                .ForMember(dest => dest.RoomId, opt => opt.MapFrom(src => src.Id))
                .ForMember(dest => dest.Title, opt => opt.MapFrom(src => src.Title))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description));

            CreateMap<Room, GetRoomResponse>(MemberList.None)
                .ForMember(dest => dest.RoomId, opt => opt.MapFrom(src => src.Id))
                .ForMember(dest => dest.RowVersion, opt => opt.MapFrom(src => src.RowVersion))
                .ForMember(dest => dest.Title, opt => opt.MapFrom(src => src.Title))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description));
