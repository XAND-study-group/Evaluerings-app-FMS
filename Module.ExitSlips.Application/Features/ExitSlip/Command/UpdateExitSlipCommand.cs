...
public record UpdateExitSlipCommand(UpdateExitSlipRequest UpdateExitSlipRequest)
...
{
    async Task<Result<bool>> IRequestHandler<UpdateExitSlipCommand, Result<bool>>.Handle(UpdateExitSlipCommand request,
