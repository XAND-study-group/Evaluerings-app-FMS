...
public record DeleteExitSlipCommand(DeleteExitSlipRequest DeleteExitSlipRequest)
...
{
    async Task<Result<bool>> IRequestHandler<DeleteExitSlipCommand, Result<bool>>.Handle(DeleteExitSlipCommand request,
