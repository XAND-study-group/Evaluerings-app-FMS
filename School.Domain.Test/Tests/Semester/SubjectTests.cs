...
public class SubjectTests
{
    ...
    public void Given_Valid_Data_Then_Subject_Created(SubjectName name, SubjectDescription description,
    ...
    public void Given_Description_Equal_To_WhiteSpace_Then_Throw_ArgumentException(string name, string description)
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            FakeSubject.Create(new SubjectName(name), new SubjectDescription(description), []));
    }
    ...
    public void Given_Null_SubjectName_Then_Throw_ArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            FakeSubject.Create(null!, new SubjectDescription("Valid description"), []));
    }
    ...
    public void Given_Valid_Data_When_Updated_Then_Properties_Updated(SubjectName initialName,
        SubjectDescription initialDescription, SubjectName newName, SubjectDescription newDescription)
    {
        // Arrange
    ...
    {
        // Arrange
        var subjectSut = FakeSubject.Create(new SubjectName("InitialName"),
            new SubjectDescription("InitialDescription"), []);

        // Act & Assert
        Assert.Throws<ArgumentNullException>(() =>
            subjectSut.Update(null!, new SubjectDescription("UpdatedDescription")));
    }
